...
# Problem B - RL2 Q-learning
## Input
```txt
Your interface with the judge is the player file player.py. For this problem, look for PlayerControllerRL class within player.py. After editing player.py, rename it as player_2.py for submission.
