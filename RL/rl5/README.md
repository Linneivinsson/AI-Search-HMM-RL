...
# Problem E - RL5 ESCAPING a sub-optimal
## Input
Your interface with the judge is the player file player.py. For this problem, look for PlayerControllerRL and ScheduleLinear classes within player.py. After editing player.py, rename it as player_5.py for submission.
